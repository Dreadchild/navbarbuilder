...
if (!pc.page.sharedObjectMgr) {
    pc.page.sharedObjectMgr = (function() {
        var a = {};
        var b = {set: function(c, d) {
                if (c.indexOf(".") == -1) {
                    a[c] = d
                }
            },get: function(c) {
                return c.indexOf(".") == -1 ? a[c] : null
            },remove: function(c) {
                if (c.indexOf(".") == -1) {
                    delete a[c]
                }
...
(function(a) {
    a.fn.pciframe = (a.browser.msie && /msie 6\.0/i.test(navigator.userAgent) ? function(e) {
        e = a.extend({top: "auto",left: "auto",width: "auto",height: "auto",opacity: true,src: "javascript:false;"}, e);
...
(function(a) {
    a.fn.hoverIntent = function(j, k) {
        var b = {sensitivityX: 28,sensitivityY: 7,interval: 100,timeout: 0};
        b = a.extend(b, k ? {over: j,out: k} : j);
        var d, e, m, n;
        var o = function(f) {
            d = f.pageX;
            e = f.pageY
...
function pcj_callext(a, b) {
    $pc.ajax({dataType: "jsonp",jsonp: a,url: b})
}
...
function atlPCSetCookie(d, e) {
    ...
    var a = d + "=" + e + "; expires=" + c.toGMTString() + "; path=/; domain=" + pcj_cookiedomain();
    document.cookie = a
}
...
function pcj_savePreferences(b, c, a) {
    ...
    $pc.ajax({dataType: "jsonp",jsonp: a,url: d,async: false})
}
...
pcsb_cookie = {pcsb_cookieInit: function(a) {
...
$pc.fn.doCall = function() {
    var a = false;
    if ((pcj_cdomain == pcj_cookiedomain()) && (pcj_call)) {
...
function pcj_saveCurrency3(a, b) {
    ...
    pcj_saveCurrency3CBImpl = new _pcj_saveCurrency3CBImpl(c, d, f);
...
var pcj_flagCurrencyState = {saveCurrency: function() {
        ...
        pcj_flagCurrencyState.isi_pageCurSelTxt = null;
        pcj_flagCurrencyState.isi_pageShowValue = null
    },isi_newflagcode: null,countrySelectName: null,hdnhidSelection: null,isi_pageCurItmSel: null,isi_pageCurSelTxt: null,isi_pageShowValue: null};
...
gbl.ns.register("pc.headers.c6.controls");
if (!pc.headers.c6.controls.menuMain_appraisals) {
    pc.headers.c6.controls.menuMain_appraisals = function() {
        this.init = function(a, c, b) {
            $pc("#pcm-domains-appraisal").click(function(f) {
                pcj_FastballPageEvent("4408", "PC_Appraisal_Modal", "clicked");
                var g = function(e, h) {
                    window.$sf = {skin: "fos",preload: 0,plabel: h};
                    $pc.getScript(e, d)
                };
                var d = function() {
                    require("starfield/sf.dialog", function() {
                        $pc("<div/>").sfDialog({autoResize: "true",load: c,title: "Instant Domain Appraisals"})
                    })
                };
